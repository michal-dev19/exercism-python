...
def singleton_ingredients(dishes, intersection):
    ...
    all_intersected_ingredients = set().intersection(*dishes)
    all_ingredients = set().union(*dishes)
    single_ingredients = all_ingredients - all_intersected_ingredients
    single_ingredients = single_ingredients - set(intersection)
